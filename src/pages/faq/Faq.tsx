...
const FAQPage = () => {
  return (
    <Box w={{ base: "90%", md: "50%" }} h="auto" mx="auto" my={10}>
      <Heading
        overflow={"hidden"}
        fontSize={{ base: 14, md: 16, lg: 22 }}
        mb={8}
        ml={18}
      >
      ...
      <Tabs>cd c
        <TabList overflow={"hidden"} w={"100%"} borderBottom="none">
          <Tab fontSize={{ base: 10, md: 12, lg: 15 }}>All</Tab>
          <Tab fontSize={{ base: 10, md: 12, lg: 15 }}>Donations</Tab>
          <Tab fontSize={{ base: 10, md: 12, lg: 15 }}>Courses</Tab>
        </TabList>
